...
function onShow(td) {
    ...
    document.getElementById('show_task_name').value = selectedRow.cells[1].innerHTML;
    document.getElementById('show_date').value = selectedRow.cells[2].innerHTML;
    document.getElementById('show_status').value = +td.status === 1 ? 'New' : (+td.status === 2 ? 'In Progress' : 'Completed');
